...
export class kilometrageService {
   ...
   url = environment.api + 'kilometrage/';
   ...
   post(kilometrage: kilometrage): Promise<any> {
      return this.http.post(this.url, JSON.stringify(kilometrage), this.options).toPromise()
      .then( r => {
         return r.json();
      }).catch( error => { return error.json(); });
   }

   put(kilometrage: kilometrage): Promise<any> {
      return this.http.put(this.url, JSON.stringify(kilometrage), this.options).toPromise()
      .then( r => {
         return r.json();
      }).catch( error => { return error.json(); });
   }
